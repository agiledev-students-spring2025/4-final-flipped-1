...
mongoose.connect(process.env.MONGO_URI)
  .then(async () => {
    ...
    const flipSeedData = [
      { task_name: "we", start_time: new Date("2025-04-29T08:00:00Z"), end_time: new Date("2025-04-29T08:30:00Z"), duration: 1800, user_id: "4@email.com" },
      { task_name: "we", start_time: new Date("2025-04-29T08:00:00Z"), end_time: new Date("2025-04-28T08:30:00Z"), duration: 1800, user_id: "4@email.com" },
      { task_name: "we", start_time: new Date("2025-04-29T08:00:00Z"), end_time: new Date("2025-04-25T08:30:00Z"), duration: 1800, user_id: "4@email.com" },
    ...
    // const taskSeedData = [
    //   { task_name: "2", color: "#dbf7ff", user_id: "all" },
